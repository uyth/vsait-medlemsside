"""
Django settings for vsait project.
...
ALLOWED_HOSTS = ['localhost','127.0.0.1','bbfa92cf93ff.ngrok.io','ccd9c5abcb74.ngrok.io','a73a175bc2ea.ngrok.io']
...
MIDDLEWARE = [
    ...
    'home.middleware.CustomMiddleware.CustomMiddleware',
]

ROOT_URLCONF = 'vsait.urls'
...
WSGI_APPLICATION = 'vsait.wsgi.application'
...
AUTH_USER_MODEL = 'home.VsaitUser' # New custom user model to be used with Django auth
