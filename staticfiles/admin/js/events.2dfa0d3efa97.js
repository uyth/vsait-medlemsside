  ...
  (function ($) {
    ...
    for (save of saves) {
      ...
      $(input).click(function () {
        ...
        const registrationDeadline_date = $("#id_registrationDeadline_0").get(
          0
        );
        const registrationDeadline_time = $("#id_registrationDeadline_1").get(
          0
        );
        const cancellationDeadline_date = $("#id_cancellationDeadline_0").get(
          0
        );
        const cancellationDeadline_time = $("#id_cancellationDeadline_1").get(
          0
        );
        ...
        const registrationDeadline = new Date(
          registrationDeadline_date.value +
            " " +
            registrationDeadline_time.value
        );
        const cancellationDeadline = new Date(
          cancellationDeadline_date.value +
            " " +
            cancellationDeadline_time.value
        );
